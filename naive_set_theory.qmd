...
-   $F = \{ x: x > 5 \text{ e } x \in \mathbb{N}\}$ onde $F$ contém todos os números maiores que $5$ que são números naturais. Nesse caso, $P(x)$ refere-se a todos os $x$ maiores que $5$ e pertencentes aos números naturais.

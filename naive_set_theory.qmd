...
A @fig-subset-venn-diagram ilustra a @def-subset usando um **diagrama de Venn**.
...
Por exemplo, se $A = \{ 1, 2 \}$ e $\Omega = \{ 1, 2, 3, 4 \}$, então $A^c = \{ 3, 4 \}$. Em R, utilizando o pacote `sets`, podemos determinar $A^c$ da seguinte maneira:
